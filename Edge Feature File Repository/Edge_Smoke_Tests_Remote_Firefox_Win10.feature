Feature: Test Firefox browser on Win10 EDGE smoke test scenarios

  Scenario: Test login, competitions, modules, and logout with valid credentials via Firefox on Win10
