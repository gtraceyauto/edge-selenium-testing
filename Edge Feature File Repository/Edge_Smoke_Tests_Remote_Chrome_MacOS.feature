Feature: Test Chrome browser on MacOS EDGE smoke test scenarios

  Scenario: Test login, competitions, modules, and logout with valid credentials via Chrome on MacOS
